...
((span[a].dataset.player === "x") || span[a].dataset.player == "y")&&
isGameOver == false
) {
...
function gameOver(a){
var gameOverAlertElement = "<b>LOJA MBAROJ</b><br><br> Lojtari " + span[a].dataset.player.toUpperCase() + ' Fitoj. Urime !!! <br><br>' + restartButton
...
function draw(){
var drawAlertElement = '<b>BARAZIM. LUANI SERISH !!!</b><br><br>' + restartButton;
var div = document.createElement("div");
div.className = "alert";
